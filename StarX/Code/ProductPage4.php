        ...
        if ($result->num_rows > 0) {
            ...
            if ($checkCartResult->num_rows > 0) {
                ...
                if ($conn->query($updateQuantityQuery) === TRUE) {
                    echo "<script>window.location.href = 'ProductPage4.php';</script>";
                } else {
    ...
    <body>
        ...
        <div class="container-2">
            <div class="product-details">
                <div>
                    <img class="product-image" src="./Images/ProductImage3.1.jpeg" id="MainImg" alt="Product Image 1">
                    <br>

                    <div class="show-image">
                        <img src="./Images/ProductImage3.1.jpeg" class="small-img" alt="Product Image 1">
                        <img src="./Images/ProductImage3.2.jpeg" class="small-img" alt="Product Image 2">
                        <img src="./Images/ProductImage3.3.jpeg" class="small-img" alt="Product Image 3">
                        <img src="./Images/ProductImage3.4.jpeg" class="small-img" alt="Product Image 4">
                    </div>
                </div>

                <div class="product-info">
                    <h1>Short Sleeved Summer Thin T-shirt</h1>
                    <div class="col">
                        <p class="price" style="font-size: 21px;">RM21.90</p>
