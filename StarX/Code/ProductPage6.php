        ...
        if ($result->num_rows > 0) {
            ...
            if ($checkCartResult->num_rows > 0) {
                ...
                if ($conn->query($updateQuantityQuery) === TRUE) {
                    echo "<script>window.location.href = 'ProductPage6.php';</script>";
                } else {
...
<body>
	...
	<div class="container-2">
        <div class="product-details">
            <div>
                <img class="product-image" src="./Images/ProductImage6.1.jpeg" id="MainImg" alt="Product Image 1">
                <br>

                <div class="show-image">
                    <img src="./Images/ProductImage6.1.jpeg" class="small-img" alt="Product Image 1">
                    <img src="./Images/ProductImage6.2.jpeg" class="small-img" alt="Product Image 2">
                    <img src="./Images/ProductImage6.3.jpeg" class="small-img" alt="Product Image 3">
                    <img src="./Images/ProductImage6.4.jpeg" class="small-img" alt="Product Image 4">
                </div>
            </div>
            ...
            <div class="product-info">
                ...
                <div class="col">
                    <p class="price" style="font-size: 21px;">RM23.90</p>
