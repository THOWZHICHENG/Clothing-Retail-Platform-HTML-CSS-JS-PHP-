<?php
        ...
        if ($result->num_rows > 0) {
            ...
            if ($checkCartResult->num_rows > 0) {
                ...
                if ($conn->query($updateQuantityQuery) === TRUE) {
                    echo "<script>window.location.href = 'ProductPage3.php';</script>";
                } else {
    ...
    <body>
        ...
        <div class="product-details">
            <div>
                <img class="product-image" src="./Images/ProductImage2.1.jpeg" id="MainImg" alt="Product Image 1">
                <br>

                <div class="show-image">
                    <img src="./Images/ProductImage2.1.jpeg" class="small-img" alt="Product Image 1">
                    <img src="./Images/ProductImage2.2.jpeg" class="small-img" alt="Product Image 2">
                    <img src="./Images/ProductImage2.3.jpeg" class="small-img" alt="Product Image 3">
                    <img src="./Images/ProductImage2.4.jpeg" class="small-img" alt="Product Image 4">
                </div>
            </div>

                <div class="product-info">
                    <h1>Hoodie Short Sleeve T-Shirt</h1>
                    <div class="col">
